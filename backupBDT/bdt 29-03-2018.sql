...
CREATE TABLE `agendas` (
  ...
  CONSTRAINT `agendas_ibfk_1` FOREIGN KEY (`idTipoAgenda`) REFERENCES `tipo_agenda` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `telefono` (
  ...
  PRIMARY KEY (`id`),
  KEY `idProveedor` (`idProveedor`),
  CONSTRAINT `telefono_ibfk_1` FOREIGN KEY (`idProveedor`) REFERENCES `proveedores` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
